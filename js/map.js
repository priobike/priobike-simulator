...
function createTrafficLight(tlID, longitude, latitude, bearing) {
    ...
    map.getSource('traffic_light').setData({ type: 'FeatureCollection', features: features });
    minimap.getSource('traffic_light').setData({ type: 'FeatureCollection', features: features });
}
